                ...
                <section id="dashboard" class="content-section active">
                    <div class="header">
                        ...
                        <div class="header-actions">
                            <div class="date-display" x-data="{ now: new Date() }" x-init="setInterval(() => now = new Date(), 1000)">📅 <span x-text="now.toLocaleDateString('en-US', { weekday: 'short', year: 'numeric', month: 'short', day: 'numeric' }) + ' ' + now.toLocaleTimeString('en-US')"></span></div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="value">{{ $activeBranches }}</div>
                            <div class="change">Registered Branch Admins</div>
                        </div>
                        <div class="stat-card">
                            <h3>Total Revenue</h3>
                            <div class="value">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</div>
                            <div class="change">Total Paid Orders</div>
                        </div>
                    </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->branchAdmin ? $order->branchAdmin->name : 'N/A' }}</td>
                                        <td>
